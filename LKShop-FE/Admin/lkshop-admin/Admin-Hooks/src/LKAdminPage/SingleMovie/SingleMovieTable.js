...
import { getListSingleMovie, getSingleMovieById, createSingleMovie, updateSingleMovie, deleteSingleMovie, getVideo } from "helpers/app-backend/singlemovie-backend-helper";
...
const SingleMovieTable = () => {
    ...
    const onClickEdit = async (id) => {
        setIsEdit(true)
        await getSingleMovieById(id).then(async (res) => {
            if (res.isSuccess) {
                ...
                // const res = await fetch('http://localhost:8000/api/v1/SingleMovie/GetVideo')
    ...
    const handleSubmit = (e) => {
        ...
        const singleMovie = {
            ...
            MovieName: movieList.find(a => a.value == e.target["Movie"].value).label,
        ...
        // formData.append('MovieName', singleMovie.MovieName);
                                                ...
                                                >
                                                    <Row form>
                                                        <Col xs={12}>
                                                            ...
                                                            {
                                                                dataEdit ?
                                                                    <video controls muted autoPlay src={`http://localhost:8000/api/v1/SingleMovie/GetVideo/Folder=MovieVideo&Movie=${dataEdit?.Movie?._id}&YearProduce=${dataEdit?.YearProduce}`} width="400">
                                                                    </video>
                                                                    : <></>
                                                            }
                                                            {
