                        ...
                        {data?.map((element, index) => {
                            return (
                                <div key={index}
                                    ...
                                    style={{ marginTop: 10, display: "flex", justifyContent: "space-between", borderBottom: "1px solid #ccc", padding: 20, background: isHover == index ? "#f1f1f1" : "white" }}>
                            ...
                            >
                                ...
                                <Row>
                                    ...
                                    <Col xs={6}>
                                        {
                                            dataEdit ?
                                                <video controls muted autoPlay src={`http://localhost:8000/api/v1/TVEpisode/GetVideo/Folder=TVVideo&Season=${dataEdit?.TVSeason?._id}&Episode=${dataEdit?.Episode}`} width="400">
                                                </video>
                                                : <></>
                                        }
                                        {
