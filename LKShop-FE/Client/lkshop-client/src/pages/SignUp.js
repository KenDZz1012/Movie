...
import { createClient } from "../helpers/app-backend/client-backend-helper";
function SignupPage() {
    ...
    async function handleSubmit(event) {
        ...
        formData.append("UserName", dataCreate.UserName)
        formData.append("Email", dataCreate.Email)
        formData.append("Password", dataCreate.Password)
